...
PICKLED_FOODS = 
{
	...
	corn = MakePickledFoodStats(		TUNING.CALORIES_MEDSMALL, 	TUNING.HEALING_TINY, 		TUNING.PERISH_PRESERVED, 	-TUNING.SANITY_SUPERTINY,	"VEGGIE", 	TUNING.STACK_SIZE_SMALLITEM),
	...
	pigs_foot = MakePickledFoodStats(	TUNING.CALORIES_LARGE, 		TUNING.HEALING_MEDLARGE, 	TUNING.PERISH_PRESERVED, 	-TUNING.SANITY_MED,			"VEGGIE", 	TUNING.STACK_SIZE_SMALLITEM),
