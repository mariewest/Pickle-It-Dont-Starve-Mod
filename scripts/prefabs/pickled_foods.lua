...
PICKLED_FOODS = 
{
	...
	cucumber = MakePickledFoodStats(	TUNING.CALORIES_SMALL, 		TUNING.HEALING_TINY, 		TUNING.PERISH_SUPERSLOW, 	TUNING.SANITY_SMALL, 		"VEGGIE", 	TUNING.STACK_SIZE_SMALLITEM),
	...
	cucumber_golden = MakePickledFoodStats(	TUNING.CALORIES_LARGE, 		TUNING.HEALING_MEDLARGE, 		TUNING.PERISH_SUPERSLOW, 	TUNING.SANITY_MEDLARGE, 		"VEGGIE", 	TUNING.STACK_SIZE_SMALLITEM,	nil),
}
